...
def talker():
    ...
    #pub part
    pub_left_s0 = rospy.Publisher('left_s0_socket', Float64, queue_size=10)
    pub_left_s1 = rospy.Publisher('left_s1_socket', Float64, queue_size=10)
    pub_left_e0 = rospy.Publisher('left_e0_socket', Float64, queue_size=10)
    pub_left_e1 = rospy.Publisher('left_e1_socket', Float64, queue_size=10)

    pub_right_s0 = rospy.Publisher('right_s0_socket', Float64, queue_size=10)
    pub_right_s1 = rospy.Publisher('right_s1_socket', Float64, queue_size=10)
    pub_right_e0 = rospy.Publisher('right_e0_socket', Float64, queue_size=10)
    pub_right_e1 = rospy.Publisher('right_e1_socket', Float64, queue_size=10)
